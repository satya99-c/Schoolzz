...
import { Building2, Shield, UserPlus, Copy, CheckCircle, School, Users, BookOpen, KeyRound, Mail, Sparkles, User } from 'lucide-react';
...
export default function SchoolAdminPortal() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#1b4d3e] text-white p-6 sm:p-8 rounded-3xl shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border border-emerald-500/30">
        <div className="space-y-1">
          ...
          <p className="text-xs text-emerald-100 font-medium">
            Organization Management & Principal Onboarding Workspace
          </p>
        </div>
      ...
      {/* Main Grid: Onboard Principal & Organization Summary */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* Form: Create Principal Account for School */}
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-3xl p-6 shadow-md space-y-5">
          <div className="flex items-center space-x-3 border-b border-slate-200 pb-4">
            ...
            <div>
              <h2 className="text-base font-extrabold text-slate-900">Onboard & Create Principal Login Account</h2>
